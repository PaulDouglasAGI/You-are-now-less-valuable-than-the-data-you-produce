...
export default function NodeComplete({
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center px-6 py-10">
      <div className="max-w-2xl w-full border border-[color:var(--color-green)]/50 bg-[color:var(--color-panel)]/70 p-8 md:p-10 fade-in text-center">
        <span className="text-[11px] tracking-[0.3em] text-[color:var(--color-green)]">TARGET SECURED</span>
        <GlitchText
          as="h1"
          text={node.org}
          className="block font-display text-2xl md:text-4xl font-bold text-[color:var(--color-green)] text-glow mt-2"
        />
